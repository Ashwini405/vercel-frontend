...
//     className="block w-full mt-4 px-4 py-3 rounded-xl bg-primary-600 text-white text-center font-semibold"
//   >
//     My Orders
//   </Link>
// )}
...
//                           <button
//                             onClick={() => handleCategoryClick(category.name.split(' ')[0])}
//                             className="text-sm text-primary-600 font-semibold hover:underline py-1"
//                           >
//                             View All →
//                           </button>
//                         </li>
...
//                 <p className="text-gray-500 dark:text-gray-400">No categories found for "{megaMenuSearch}"</p>
//               </div>
//             )}

//             {/* Quick Links */}
//             <div className="mt-6 pt-6 border-t dark:border-gray-700 flex items-center justify-center gap-6">
//               <a href="#" className="flex items-center gap-2 text-gray-600 dark:text-gray-400 hover:text-primary-600 transition-colors">
...
//       {/* Mobile Menu */}
//       {isMenuOpen && (
//         <div className="absolute top-full left-0 w-full bg-white dark:bg-gray-800 shadow-lg border-t dark:border-gray-700 z-50 max-h-[80vh] overflow-y-auto">
...
//                   className="w-full pl-10 pr-4 py-3 rounded-xl border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-white"
//                 />
...
//                 return (
//                   <div key={category.name} className="border-b dark:border-gray-700 pb-2">
//                     <button
//                       onClick={() => setActiveCategory(isActive ? null : category.name)}
//                       className={`flex items-center justify-between w-full p-3 rounded-xl ${category.color} transition-all`}
//                     >
...
//                             key={item}
//                             onClick={() => handleItemClick(item)}
//                             className="block w-full text-left py-2 px-3 text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors"
//                           >
//                             {item}
//                           </button>
//                         ))}
...
//               <label className="text-sm text-gray-500 dark:text-gray-400">Sort by Price</label>
//               <select
//                 value={sortOrder}
//                 onChange={(e) => setSortOrder(e.target.value as any)}
//                 className="w-full mt-2 px-3 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-700 text-gray-700 dark:text-gray-200"
//               >
...
//                   </div>
//                   <button className="w-full btn-primary py-3 text-lg mb-2"  onClick={() => {
